...
//
//        public EmiAnvilCombineRecipe(EmiStack input1, EmiStack input2, EmiStack output, Identifier id) {
...
//                Identifier.tryBuild("shields", "/plating_upgrade_" + BuiltInRegistries.ITEM.getKey(platedShield).getPath() + "_" + BuiltInRegistries.ITEM.getKey(platedShield).getPath())
//            ));
//        }
//    }
//}
